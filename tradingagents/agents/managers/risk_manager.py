    ...
    def risk_manager_node(state) -> dict:
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ...
            ("system", 
                ...
                "3. Refine the Trader's Plan: Adjust the trader's original plan based on the analysts' insights.\n"
                "4. Learn from Past Mistakes: Use lessons from past reflections to address prior misjudgments and improve the current decision.\n\n"
                "Deliverables:\n"
